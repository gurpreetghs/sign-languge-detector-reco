...
class Application:
    def __init__(self):
        ...
        self.panel.place(x = 50, y = 5, width = 600, height = 500)
        self.panel2 = tk.Label(self.root) # initialize image panel
        self.panel2.place(x = 350, y = 40, width = 300, height = 300)
        
        self.T = tk.Label(self.root)
        self.T.place(x=50,y = 1)
        self.T.config(text = "Sign Language to Text",font=("courier",25))
        self.panel3 = tk.Label(self.root) # Current SYmbol
        self.panel3.place(x = 400,y=500)
        self.T1 = tk.Label(self.root)
        self.T1.place(x = 10,y = 500)
        self.T1.config(text="Character :",font=("Courier",15,"bold"))
        self.panel4 = tk.Label(self.root) # Word
        self.panel4.place(x = 220,y=530)
        self.T2 = tk.Label(self.root)
        self.T2.place(x = 10,y = 530)
        self.T2.config(text ="Word :",font=("Courier",15,"bold"))
        self.panel5 = tk.Label(self.root) # Sentence
        self.panel5.place(x = 350,y=560)
        self.T3 = tk.Label(self.root)
        self.T3.place(x = 10,y = 560)
    ...
    def action_call(self) :
        ...
        self.root1.geometry("250x100")
        
        
        self.tx = tk.Label(self.root1)
        self.tx.place(x = 10,y = 10)
        self.tx.config(text = "Made By", fg="red", font = ("Courier",25))
        self.tx = tk.Label(self.root1)
        self.tx.place(x = 11,y = 50)
        self.tx.config(text = "Gurpreet Singh", fg="blue", font = ("Courier",20))
